...
print('y train datatype', y_train.dtype)
...
weights_posit_1 = np.float32(model.layers[1].get_weights()[0]);
bias_posit_1 = np.float32(model.layers[1].get_weights()[1])

weights_posit_3 = np.float32(model.layers[3].get_weights()[0])
bias_posit_3 = np.float32(model.layers[3].get_weights()[1])

weights_posit_6 = np.float32(model.layers[6].get_weights()[0])
bias_posit_6 = np.float32(model.layers[6].get_weights()[1])

weights_posit_8 = np.float32(model.layers[8].get_weights()[0])
bias_posit_8 = np.float32(model.layers[8].get_weights()[1])

weights_posit_11 = np.float32(model.layers[11].get_weights()[0])
bias_posit_11 = np.float32(model.layers[11].get_weights()[1])

weights_posit_13 = np.float32(model.layers[13].get_weights()[0])
bias_posit_13 = np.float32(model.layers[13].get_weights()[1])

weights_posit_18 = np.float32(model.layers[18].get_weights()[0])
bias_posit_18 = np.float32(model.layers[18].get_weights()[1])

weights_posit_20 = np.float32(model.layers[20].get_weights()[0])
bias_posit_20 = np.float32(model.layers[20].get_weights()[1])
