...
weights_posit_22 = np.float32(model.layers[22].get_weights()[0])
bias_posit_22 = np.float32(model.layers[22].get_weights()[1])

print('shape', weights_posit_18.shape)
print('shape', weights_posit_20.shape)
print('shape', weights_posit_22.shape)
...
l22 = []
ww22 = weights_posit_22  # weights
bb22 = bias_posit_22  # biases
l22.append(ww22)
l22.append(bb22)
ls22 = model.layers[22].set_weights(l22)
...
r = model.fit(x_train, y_train, validation_data=(x_test, y_test), epochs=50, use_multiprocessing=True , workers= 4)
