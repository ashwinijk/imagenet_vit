...
weights_posit_28 = tf.cast(model.layers[28].get_weights()[0], tf.bfloat16)
bias_posit_28 = tf.cast(model.layers[28].get_weights()[1], tf.bfloat16)

weights_posit_30 = tf.cast(model.layers[30].get_weights()[0], tf.bfloat16)
bias_posit_30 = tf.cast(model.layers[30].get_weights()[1], tf.bfloat16)

weights_posit_32 = tf.cast(model.layers[32].get_weights()[0], tf.bfloat16)
bias_posit_32 = tf.cast(model.layers[32].get_weights()[1], tf.bfloat16)
